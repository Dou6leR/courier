...
import { Package, Bell, User, History } from "lucide-react";

export default function Layout() {
  const location = useLocation();

  const navItems = [
    { path: "/client", label: "Доставки", icon: Package },
    { path: "/client/pending", label: "Підтвердження", icon: Bell },
    { path: "/client/archive", label: "Архів", icon: History },
    { path: "/client/profile", label: "Профіль", icon: User },
  ];
