    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center">
      <div className="w-full max-w-[390px] bg-white min-h-screen flex flex-col shadow-lg">
        <div className="flex flex-col items-center pt-16 pb-8">
          ...
          <h1 className="text-gray-900 font-semibold text-xl">Адмін вхід</h1>
        ...
        <form onSubmit={onSubmit} className="px-6 space-y-4 flex-1">
          ...
          <Button
            type="submit"
            className="w-full bg-slate-800 hover:bg-slate-900 text-white h-11 rounded-xl"
            disabled={loading}
          >
            {loading ? "Вхід…" : "Увійти"}
          </Button>
